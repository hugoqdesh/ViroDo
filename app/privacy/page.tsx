  ...
  return (
    <main>
      ...
      <section className="flex flex-col gap-8 px-8 text-neutral-300 max-w-6xl mx-auto">
        <h1 className="mt-36 text-4xl font-bold">Privacy Policy</h1>
        <div>
          ...
          <ul>
            <li>
              ...
              <Link href="x" target={"_blank"} className="text-white underline">
                x
              </Link>
            </li>
            <li>
          ...
          <ul>
            <li>- Your discord/gmail username and avatar.</li>
          </ul>
          <p>
            <br />
          ...
          <p>
            ...
            our website. By accessing or using this website, you agree to this
            ...
            acceptance of those changes, so please check the policy every once
            in a while for updates.
          </p>
          <h3 className="my-4 text-lg font-bold text-white">
            {" "}
          ...
          <p>
            ...
            13. The Creator does not knowingly collect personal information from
            children under 13 years of age. If you are a parent or guardian and
            believe that your child has provided personal information to the
            website, please contact the Creator to request deletion of that
            information.
          </p>
          ...
          <p>
            This website or messages distributed by our website may contain
            links to third-party websites. These linked websites are not under
            our control, and we are not responsible for the privacy practices or
            the contents of any such linked website or any link contained in any
            ...
            linked website by ViroDo. If you provide any personal data through
            any such third-party website, your transaction will occur on the
            third party&apos;s website (not this website) and the personal data
            you provide will be collected by and controlled by the privacy
          ...
          <p>
            ...
            provide to us through the website. It does not govern the manner in
